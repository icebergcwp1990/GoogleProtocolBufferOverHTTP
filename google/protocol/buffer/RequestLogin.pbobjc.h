 ...
 **/
@interface RequestLoginRoot : GPBRootObject
@end

#pragma mark - Login

typedef GPB_ENUM(Login_FieldNumber) {
  Login_FieldNumber_Identify = 1,
  Login_FieldNumber_Name = 2,
  Login_FieldNumber_Password = 3,
  Login_FieldNumber_Type = 4,
};

@interface Login : GPBMessage

@property(nonatomic, readwrite) int32_t identify;

@property(nonatomic, readwrite) BOOL hasIdentify;
